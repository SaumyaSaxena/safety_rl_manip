...
class MATSAC:
    def __init__(self, env_dict, hp_dict, train_or_test="train"):
        ...
        # TODO, Saumya: Replace the following with your replay buffer
        ...
        if self.hp_dict['optim']=="adam":
            ...
            self.optimizer_actor = optim.AdamW(filter(lambda p: p.requires_grad, self.tf.decoder_actor.parameters()), lr=hp_dict['pi_lr'], weight_decay=1e-2)
    ...
    def compute_q_loss(self, s1, a, s2, r, d, pos):
        ...
        with torch.autocast(device_type="cuda", dtype=torch.bfloat16):
            ...
            with torch.no_grad():
                ...
                # q_next = r.unsqueeze(1) # For Bandit-like problems
    ...
    def update(self, current_episode, n_updates, avg_reward):
        ...
        for j in range(n_updates):
            ...
            # TODO, Saumya: If you want to warm-start your training, uncomment this
            ...
            # Critic Update
            # Instead of zero_grad, do this, it is more efficient
    ...
    def load_saved_policy(self, path=None):
        if path is None:
            path = f'{self.hp_dict['data_dir']}/{self.hp_dict['exp_name']}/pyt_save/model.pt'
...
if __name__=="__main__":
    ...
    hp_dict = {
            ...
            'SCE_embed_loc'     : '<path to pretrained embeddings>',
        }